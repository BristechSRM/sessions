...
let getByProfileId (profileId : Guid) = getConnection().Query<Handle> ("select profileId, type, identifier from handles where profileId = @ProfileId", dict [ "ProfileId", box profileId ])
